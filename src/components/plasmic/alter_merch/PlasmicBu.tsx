...
import sty from "./PlasmicBu.module.css"; // plasmic-import: z2uv9u-BwSf/css
...
export type PlasmicBu__VariantMembers = {
...
export type PlasmicBu__VariantsArgs = {
...
type VariantPropType = keyof PlasmicBu__VariantsArgs;
export const PlasmicBu__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export type PlasmicBu__ArgsType = {
  children?: React.ReactNode;
  startIcon?: React.ReactNode;
  endIcon?: React.ReactNode;
  link?: string;
};
type ArgPropType = keyof PlasmicBu__ArgsType;
export const PlasmicBu__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link"
...
export type PlasmicBu__OverridesType = {
  root?: p.Flex<"button">;
...
export interface DefaultBuProps extends pp.BaseButtonProps {
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
  color?: SingleChoiceArg<
    | "blue"
...
function PlasmicBu__RenderFunc(props: {
  variants: PlasmicBu__VariantsArgs;
  args: PlasmicBu__ArgsType;
  overrides: PlasmicBu__OverridesType;
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___5Muur)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__bqs2)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.BaseButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicBu>(
    PlasmicBu,
    props,
    {
...
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicBu__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicBu__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicBu__ArgProps,
          internalVariantPropNames: PlasmicBu__VariantProps
        }),
      [props, nodeName]
    );

    return PlasmicBu__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicBu";
  } else {
    func.displayName = `PlasmicBu.${nodeName}`;
  }
  return func;
}

export const PlasmicBu = Object.assign(
  // Top-level PlasmicBu renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicBu
    internalVariantProps: PlasmicBu__VariantProps,
    internalArgProps: PlasmicBu__ArgProps,

    useBehavior
  }
);

export default PlasmicBu;
/* prettier-ignore-end */
