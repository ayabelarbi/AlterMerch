...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 5W9CbZmWGV-/css
...
export type PlasmicButton__VariantMembers = {
  ...
  shape: "rounded" | "round" | "sharp" | "sharp2";
...
export type PlasmicButton__VariantsArgs = {
  ...
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp" | "sharp2">;
    ...
    <p.Stack
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootshape_sharp2]: hasVariant(variants, "shape", "sharp2"),
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__lbzcx)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__w65Tf)}
                role={"img"}
              />
            ),
