...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: B3eYYdwxgSa/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: N7GU47GWgRt/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__zejAu)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__ugben)}
              />
            </React.Fragment>
          ),
          value: args.children
