...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: IpYfBaDpjAA/component
import Select__Option from "../../Select__Option"; // plasmic-import: rvuuOS7g1Vh/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic_alter_merch.module.css"; // plasmic-import: xtfWGDm5314EDVZ9cvmE1G/projectcss
import sty from "./PlasmicSelect.module.css"; // plasmic-import: N7GU47GWgRt/css

import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: 4t_uyeDCGeM/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: AwfM46m2Tml/icon
              ...
              {p.renderPlasmicSlot({
                defaultContents: (
                  <React.Fragment>
                    ...
                    <Select__Option
                      className={classNames("__wab_instance", sty.option__z8Rr)}
  ...
  if (!("children" in props)) {
    props = {
      ...
      children: (
        <React.Fragment>
          <Select__Option
            className={classNames("__wab_instance", sty.option__cfZ8H)}
            value={"value1" as const}
          >
            {"Option 1"}
          </Select__Option>
